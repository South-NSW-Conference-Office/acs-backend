...
serviceSchema.index({ name: 'text', descriptionShort: 'text', descriptionLong: 'text', tags: 'text' });
...
serviceSchema.methods.canBeViewedBy = function(user) {
  return this.status === 'active' || (user && user.organizations.some(org => 
...
serviceSchema.statics.findByOrganization = function(organizationId, includeArchived = false) {
